...
public class TilemapVisual : MonoBehaviour {
    ...
    public struct TilemapSpriteUV {
        public TilemapCodeMonkey.TilemapObject.TilemapSprite tilemapSprite;
    ...
    private Grid<TilemapCodeMonkey.TilemapObject> grid;
    private Mesh mesh;
    private bool updateMesh;
    private Dictionary<TilemapCodeMonkey.TilemapObject.TilemapSprite, UVCoords> uvCoordsDictionary;
    ...
    private void Awake() {
        ...
        uvCoordsDictionary = new Dictionary<TilemapCodeMonkey.TilemapObject.TilemapSprite, UVCoords>();
    ...
    public void SetGrid(TilemapCodeMonkey tilemap, Grid<TilemapCodeMonkey.TilemapObject> grid) {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, Grid<TilemapCodeMonkey.TilemapObject>.OnGridObjectChangedEventArgs e) {
        updateMesh = true;
    }
    ...
    private void UpdateHeatMapVisual() {
        ...
        for (int x = 0; x < grid.GetWidth(); x++) {
            for (int y = 0; y < grid.GetHeight(); y++) {
                ...
                TilemapCodeMonkey.TilemapObject gridObject = grid.GetGridObject(x, y);
                TilemapCodeMonkey.TilemapObject.TilemapSprite tilemapSprite = gridObject.GetTilemapSprite();
                Vector2 gridUV00, gridUV11;
                if (tilemapSprite == TilemapCodeMonkey.TilemapObject.TilemapSprite.None) {
